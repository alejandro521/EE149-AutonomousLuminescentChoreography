...
#line 88 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
// Implementation of method receiveMessage()
void _choreo_main_method_receiveMessage(void* instance_args, char* received_message) {
    _choreo_main_main_self_t* self = (_choreo_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    #line 89 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
     char received_char;
...
void _choreo_mainreaction_function_0(void* instance_args) {
    ...
    #line 120 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
...
void _choreo_mainreaction_function_1(void* instance_args) {
    ...
    #line 142 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
    ...
    if (self->leds_on) {
      if (self->leds_blink) {
        ...
        gpio_put(YELLOW_LED_PIN, !gpio_get(YELLOW_LED_PIN));
          //self->leds_state = !self->leds_state;
      } else {
        gpio_put(RED_LED_PIN, 1);
...
void _choreo_mainreaction_function_2(void* instance_args) {
    ...
    #line 236 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
    static char buf[17];
...
void _choreo_mainreaction_function_3(void* instance_args) {
    ...
    #line 256 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
    static char buf[17];
...
_choreo_main_main_self_t* new__choreo_main() {
    ...
    #line 15 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/lib/AngleToDistance.lf"
    #endif // FEDERATED
    #line 119 "/home/foobar/EE149-AutonomousLuminescentChoreography/src/Choreo.lf"
